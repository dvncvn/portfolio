...
export function WorkSectionHeader({ projects }: WorkSectionHeaderProps) {
  ...
  const introText = {
    name: "Simon Duncan",
    bio: "I'm a Staff Product Designer working on agentic experiences at AlphaSense. I turn complex systems into clear, usable, and durable products. I'm experienced across OSS, startups, and enterprise.",
