    ...
    <>
      ...
      >
        ...
        >
          <Link
            href="/info"
            className="group/btn relative inline-flex cursor-pointer items-center gap-2 px-3 py-1.5 rounded-md bg-white/[0.04] text-muted-foreground transition-all duration-200 ease-out hover:text-foreground hover:bg-white/[0.08]"
